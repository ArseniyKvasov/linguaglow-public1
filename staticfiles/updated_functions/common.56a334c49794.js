        ...
        group.forEach(s => {
            ...
            li.innerHTML = `
                ...
                <div class="section-action-buttons align-items-center" style="display: flex; gap: 0.5rem;">
                    <button type="button" class="btn btn-link p-0 edit-section-button" data-section-id="${sectionId}" title="Редактировать">
                        <i class="bi bi-pencil-fill text-secondary"></i>
                    </button>
                    <button type="button" class="btn btn-link p-0 delete-btn" onclick="handleDeleteSection('${sectionId}')" title="Удалить">
