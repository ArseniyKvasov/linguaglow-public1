...
async function saveTaskWithData(container, { taskType, taskId = null, editMode = false }, data) {
    ...
    try {
        ...
        console.log(typeof returnTaskTypes === 'function');
...
async function initializeGenerationWindow(type, options = ["context", "quantity", "fillType", "matchType", "language", "sentenceLength", "query", "image"]) {
    ...
    generateButton.addEventListener("click", async () => {
        ...
        data.quantity = options.includes("quantity") ? parseInt(container.querySelector("#quantity").value) : undefined;
        data.fillType = options.includes("fillType") ? container.querySelector("#taskTypeSelect").value : undefined;
        data.matchType = options.includes("matchType") ? container.querySelector("#taskSubTypeSelect").value : undefined;
        data.testType = options.includes("testType") ? container.querySelector("#testTypeSelect").value : undefined;
        data.language = options.includes("language") ? container.querySelector("#languageSelect").value : undefined;
        data.sentenceLength = options.includes("sentenceLength") ? parseInt(container.querySelector("#length").value) : undefined;
